package com.calculatoronyourtips;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonC , buttonOpenBract , buttonCloseBract;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonOpenBract , R.id.button_open_braket);
        assignId(buttonCloseBract , R.id.button_close_bracket);
        assignId(buttonDivide , R.id.button_divide);
        assignId(buttonMultiply , R.id.button_multiply);
        assignId(buttonPlus , R.id.button_addtion);
        assignId(buttonSubtract , R.id.button_substraction);
...
//        solutionTextView.setText(buttonText);
